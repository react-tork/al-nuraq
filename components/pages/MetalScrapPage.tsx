  ...
  return (
    <main>
        ...
        breadcrumbs={[
          { label: getTranslation("common.home", locale), href: "/" },
          {
            label: getTranslation(
              "metalScrap.banner.breadcrumbServices",
              locale,
            ),
            href: "/services",
          },
      ...
      <InfoListSection
        ...
        image={{
          src: "https://images.unsplash.com/photo-1763926025420-adf538deaee4?q=80&w=1143&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
