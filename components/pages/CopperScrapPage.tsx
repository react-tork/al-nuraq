  ...
  return (
    <main>
        ...
        breadcrumbs={[
          { label: getTranslation("common.home", locale), href: "/" },
          {
            label: getTranslation(
              "copperScrap.banner.breadcrumbServices",
              locale,
            ),
            href: "/services",
          },
      ...
      <InfoListSection
        ...
        image={{
          src: "https://plus.unsplash.com/premium_photo-1754650790891-554d82b1a95e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
