...
const accordionItems: AccordionItem[] = [
  {
    ...
    links: [
      ...
      { href: "/scrap/iron-steel-scrap", labelKey: "header.ironSteelScrap" },
      { href: "/scrap/cable-wire-scrap", labelKey: "header.cableWireScrap" },
      ...
      { href: "/scrap/cars", labelKey: "header.carsScrap" },
      { href: "/scrap/household", labelKey: "header.householdScrap" },
      { href: "/scrap/electrical-panels", labelKey: "header.electricalPanelsScrap" },
